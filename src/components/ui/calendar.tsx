  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_dropdowns: "flex gap-1 pointer-events-auto",
        dropdown: "pointer-events-auto",
        dropdown_month: "pointer-events-auto",
        dropdown_year: "pointer-events-auto",
        vhidden: "sr-only",
        nav: "space-x-1 flex items-center pointer-events-auto z-10",
        nav_button: cn(
          buttonVariants({ variant: "outline" }),
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 pointer-events-auto cursor-pointer",
        ),
