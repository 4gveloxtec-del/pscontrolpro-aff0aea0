...
import { Send, Copy, MessageCircle, CreditCard, Tv, Wifi, Crown, Tag, Loader2, Calendar, RefreshCw, Bell, CheckCircle, Zap } from 'lucide-react';
...
export function SendMessageDialog({ client, open, onOpenChange, onMessageSent }: SendMessageDialogProps) {
  ...
  const { data: templates = [] } = useQuery({
    ...
    queryFn: async () => {
      ...
      // Etapa 4 (UI): evitar duplicidade visual (mesmo owner + nome + tipo)
